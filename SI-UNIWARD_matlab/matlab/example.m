...
SI_UNIWARD(precover, cover_path, stego_path, payload, quality_factor);
...
fprintf('\nElapsed time: %.4f s, change rate per nzAC: %.4f, nzAC: %d', Mend, sum(S_STRUCT.coef_arrays{1}(:)~=C_STRUCT.coef_arrays{1}(:))/nzAC, nzAC);